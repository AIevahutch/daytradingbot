...
An experimental lane that has earned notification privileges by reaching at least 25 closed paper alerts, 75%+ win rate, positive expectancy near +0.40R or better, profit factor 2.0+, no worse than -3R max drawdown, and performance across at least three trading days.
